import { Controller, Post, Get, Req,Put, Delete, Body, Param, Query, UseGuards, Request, Bind, Dependencies, UseInterceptors, UploadedFile, UsePipes, ValidationPipe } from '@nestjs/common';
...
export class OutfitController {
    ...
    @Post(':id/wear')
    async logWear(@Req() req, @Param('id') outfitId) {
        const userId = req.user.id;
